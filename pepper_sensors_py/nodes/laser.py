...
class NaoqiLaser(NaoqiNode):
    ...
    PEPPER_LASER_FREQ = 6.66 # [hZ] --> check on that
    PEPPER_LASER_MIN_ANGLE = -0.523598776 # [rad]
    PEPPER_LASER_MAX_ANGLE = 0.523598776  # [rad]
    ...
    PEPPER_LASER_MAX_RANGE = 4.0  # [m] --> same here, 4m as tested in the CLF lab
    ...
    # MEM DATA LIST FOR MOR EFFICIENT RETRIEVAL OF VALUES
    PEPPER_MEM_DATA_LIST_SRD_FRONT = []
    PEPPER_MEM_DATA_LIST_SRD_LEFT = []
    PEPPER_MEM_DATA_LIST_SRD_RIGHT = []
    ...
    def __init__(self, pointcloud=True, laserscan=False):
        ...
        self.laserRate = rospy.Rate(rospy.get_param(self.PARAM_LASER_RATE, self.PARAM_LASER_RATE_DEFAULT))
    ...
    def connectNaoQi(self):
        ...
        if self.memProxy is None: # self.laserProxy is None or
    ...
    def createLaserMessage(self, frameID, keyPrefix, scanNum):
        ...
        laserScanMsg.time_increment = (1 / self.PEPPER_LASER_FREQ) / scanNum
        laserScanMsg.scan_time = 1 / self.PEPPER_LASER_FREQ
        return laserScanMsg
